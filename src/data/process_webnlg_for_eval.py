# process raw webnlg data to obtain references, for later evaluation with `multi-bleu.perl`
# todo: understand the tokenization?
...
# path to raw webnlg data (https://gitlab.com/shimorina/webnlg-dataset/-/tree/master/webnlg_challenge_2017)
folder = str(project_dir / "data/raw/webnlg/webnlg_challenge_2017")
# folder = sys.argv[1]
...
path = str(project_dir / "data/processed/webnlg_eval")
...
for idx, datapoints in enumerate(dataset_points):
    ...
    if part != "train":
        ...
        # os.system(
        #     "python " + path_c + "/" + "convert_files_crf.py " + path + "/" + part
        # )
        # os.system(
        #     "python " + path_c + "/" + "convert_files_meteor.py " + path + "/" + part
        # )
